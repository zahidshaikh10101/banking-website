	...
	<header class="text-gray-600 body-font header">
		<div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
			...
			<nav class="md:ml-auto flex flex-wrap items-center text-base justify-center"> <a class="inline-block py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold hover:bg-blue-200 rounded text-lg" href="index.php">Home</a>
				...
				<a class="bg-blue-200 text-lg inline-block border-l border-t border-r rounded-t py-2 px-4 text-black-700 font-semibold" href="add.php">Add Users</a>
					...
					<div class="flex flex-wrap -m-2">
						...
						<div class="p-2 w-2/4">
							<div class="relative">
								...
								<input type="text" id="balance" name="balance" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
							</div>
						</div>
						<div class="p-2 w-full">
							<button class="w-full rounded-full text-gray-100 text-white bg-blue-400 border-0 py-2 focus:outline-none hover:bg-blue-600 rounded text-lg shadow" name="submit" type="submit" id="myBtn">Add User&nbsp;<i class="fa fa-user-plus" aria-hidden="true"></i>
							</button>
						</div>
